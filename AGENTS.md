...
- First visit must not block on the entire 1,200-frame cinematic archive. Gate entry on the small set of opening frames, then immediately warm a prioritized, chapter-entry-first cache in the background so subsequent scrolling remains continuous.
