...
- First visit must not block on the entire 1,200-frame cinematic archive. Gate entry on the small set of opening frames, then warm only the current and next chapter in capped-concurrency windows; expand those windows after brief reading time and advance them with chapter navigation. Never queue the full archive at once.
