...
- First visit waits for the complete cinematic frame sequence so entering never compromises scroll-film continuity. Use the dedicated lightweight 960×540 background frame set rather than the original 1920×1080 masters, then retain a generous decoded playback window and look-ahead buffer to keep scrolling smooth.
